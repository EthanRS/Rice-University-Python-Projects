...
def deal():
    ...
    message = "Game in Progress. Click hit or stand."
...
def stand():
    ...
    if in_play:
        if not my_hand.busted():
            ...
            message = "You already busted. Play again?"
...
def draw(canvas):
    # decoration
    canvas.draw_text("Blackjack", TITLE_POS, 36, "Green")
    canvas.draw_text("score " + str(score), SCORE_POS, 24, "White")
    canvas.draw_text(message, MESSAGE_POS, 24, "Yellow")
